 ...
 * All found reservations are displayed in a ResCard (same as dashboard)
...
export default function ResSearch() {
    ...
    //creates a ResCard for each found reservation. 
    const reservationCards = foundReservations.map((foundReservation) => {
        return <ResCard key={foundReservation.reservation_id} reservation={foundReservation} />
    });
